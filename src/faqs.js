      ...
      <div className="container w-full md:w-1/2 mx-auto flex flex-col px-16 py-24 justify-center items-center">
        ...
        <div className="mb-5 text-md sm:text-lg">
          ...
          <p className="text-xs leading-relaxed sm:text-lg">
            ...
            wisdom and acuity. Founded in 2000, the AISYWLC has grown over the
            years to become the biggest event on the calendar for IEEE members
            ...
            the AISYWLC empowers its participants to be inspired, collaborate
          ...
          <p>Where will AISYWLC 2020 be held?</p>
          <p className="text-xs leading-relaxed sm:text-lg">AISYWLC 2020 is conducted across the India in Hybrid mode.</p>
          ...
          <p className="text-xs leading-relaxed sm:text-lg">
            See the program section on the AISYWLC 2020 website
            http://aisywc.in/. A schedule of events will also be shared with
            you.
          </p>
          <p>Which events can I attend?</p>
          <p className="text-xs leading-relaxed sm:text-lg">
            Anyone who has registered for AISYWLC 2020 and has paid the Congress
