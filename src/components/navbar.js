...
const Navbar = () => {
  return (
    <header className="text-white body-font z-10 top-0 fixed w-screen bg-gray-800">
      <div className="flex justify-between items-center h-20 px-4">
        ...
        <nav className=" mx-1 md:block hidden">
          <Link activeClass="active" className=" mr-5 hover:text-yellow-600"  to="home"  smooth={true} duration={500}>
          HOME
          </Link>
