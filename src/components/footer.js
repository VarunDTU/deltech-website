  ...
  return (
    <>
      ...
      <footer className=" bg-white dark:bg-gray-900 p-10 w-full">
        <div className="md:pt-10 w-full flex items-center flex-col lg:flex-row justify-evenly">
          <div className="flex flex-col items-center mb-6 ml-4 md:mb-0">
            <div className="self-center mb-8 text-lg md:text-2xl  font-semibold whitespace-nowrap dark:text-white">
              For Any Queries Contact :
            </div>
            <div className="flex flex-col justify-evenly items-center md:flex-row ">
              <div className="p-4 w-72 mb-5 flex flex-col justify-evenly items-center md:mr-5 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
              ...
              <div className="p-4 w-72 mb-5 bg-white flex flex-col justify-evenly items-center rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <p className="text-gray-500 text-xs text-center font-normal pb-2">
                  Vice President
                </p>
                <h5 className="mb-2 md:text-lg font-bold text-gray-900 dark:text-white">
          ...
          <div className="md:px-10 w-72 mb-5 flex flex-col items-center">
            <h5 className="mb-2 md:text-lg font-bold text-gray-900 dark:text-white">
              Get In TOUCH
            </h5>
